...
function DetailTodo({route}) {
    ...
    return (
        <View my={20} mx={5} px={5} py={5} height={heightPercentageToDP('85%')} rounded="2xl" backgroundColor="blue.200">
            <Flex direction="row" mb={5} justifyContent="center" >
                <Center>
                    <Text fontSize="xl" fontWeight="bold"> {listData.name} </Text>
                </Center>
                <Spacer />
                <View>
                    <View mb={3} rounded="full" py={1} px={2} style={{ backgroundColor: 'red', alignSelf: 'flex-start' }}>
